  ...
  <div class="home row">
    ...
    <div class="col-md-9">
      ...
      <ul>
        ...
        <li>
          <a
            href="https://github.com/jhipster/generator-jhipster-micronaut/issues?state=open"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <p>
        ...
        <a
          href="https://github.com/jhipster/generator-jhipster-micronaut"
          target="_blank"
          rel="noopener noreferrer"
          v-text="t$('home.github')"
        ></a
        >!
      </p>
    </div>
